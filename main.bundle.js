...
var URL = "https://projet-pierrat.herokuapp.com";
var MeteoService = /** @class */ (function () {
    function MeteoService(http) {
        this.http = http;
    }
    MeteoService.prototype.GetAllTowns = function () {
        return this.http.get(URL + '/towns.json');
    };
    MeteoService.prototype.GetTownById = function (id) {
        return this.http.get(URL + '/towns/' + id + '.json');
    };
    MeteoService.prototype.UpdateTown = function (town) {
        return this.http.put(URL + '/towns/' + town.id + '.json', town, { headers: headers });
    };
...
module.exports = "\n<div class=\"card\">\n  <div class=\"card-content\">\n    <p>{{city.name}}\n      <i class=\"wi fa-3x  wi-forecast-io-{{city.icon}}\"></i>\n      {{city.temperature}}°C\n    </p>\n    <div class=\"card-content\">\n    </div>\n  </div>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__town__ = __webpack_require__("./src/app/town.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__meteo_service__ = __webpack_require__("./src/app/meteo.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MeteoComponent = /** @class */ (function () {
    function MeteoComponent(MeteoService) {
        this.MeteoService = MeteoService;
        this.city = new __WEBPACK_IMPORTED_MODULE_1__town__["a" /* Town */]();
    }
    MeteoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.MeteoService.GetTownById(4).subscribe(function (town) { return _this.city = town; });
    };
    MeteoComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_2__meteo_service__["a" /* MeteoService */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__meteo_service__["a" /* MeteoService */]])
    ], MeteoComponent);
